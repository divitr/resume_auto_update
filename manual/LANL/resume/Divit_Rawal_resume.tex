...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Physics and Mathematics, Minor in Electrical Engineering \& Computer Science}{Berkeley, CA}
      \resumeItemListStart
        \resumeItem{2023 National Merit Scholarship Finalist (awarded to \textless 1\% of students)}
        \resumeItem{Relevant Coursework: Data Structures, Computer Programs, Mathematical Physics, Mechanics and Relativity, Designing Information Devices and Systems, Hands-On PCB Engineering}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Contribute to the \href{https://github.com/opensearch-project/ml-commons/}{\underline{opensearch-project/ml-commons}} GitHub repository by developing machine learning algorithms and plugins in Java}
        \resumeItem{Collaborate with undergraduate students, graduate students, and industry professionals across the globe under the mentorship of Machine Learning Engineers at Amazon}
    \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
          {\textbf{Amazon OpenSearch} $|$ \emph{Java, Git, Machine Learning, Mockito}}{Aug. 2023 -- Present}
          \resumeItemListStart
            \resumeItem{Selected as member of 2023 OpenSearch Contributor Initiative (\textless 4\% acceptance rate)}
            \resumeItem{Contribute to \href{https://github.com/opensearch-project/ml-commons/}{\underline{opensearch-project/ml-commons}} GitHub repository by developing machine learning algorithms and plugins in Java}
            \resumeItem{Collaborate with undergraduate students, graduate students, and industry professionals across the globe under the mentorship of machine learning engineers at Amazon}
          \resumeItemListEnd
    
     \resumeProjectHeading
          {\textbf{Statistical Mechanics of Neural Networks} $|$ \emph{Markov Chains, Monte Carlo Estimation}}{Aug. 2023 -- Present}
          \resumeItemListStart
            \resumeItem{Working with a fourth-year graduate student as a part of the UC Berkeley Physics Directed Reading Program}
            \resumeItem{Studied statistical and thermal physics and their application to neural networks and machine learning through Markov Chain Monte Carlo Sampling and simulated annealing}
          \resumeItemListEnd
